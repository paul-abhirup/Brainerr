...
export function AppSidebar({ userEmail }: { userEmail: string }) {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-40 hidden w-64 flex-col border-r border-border-subtle bg-surface-1/95 backdrop-blur-md md:flex">
      <div className="flex h-16 items-center gap-3 px-5 border-b border-border-subtle/50">
        ...
        <div>
          ...
          <span className="text-[10px] text-text-disabled tracking-wider uppercase font-medium">2nd Brain ADHD</span>
        </div>
      </div>
